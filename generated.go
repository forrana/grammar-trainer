...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	return ec.marshalNTodo2ᚖgithubᚗcomᚋforranaᚋgrammarᚑtrainerᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNTodo2ᚕgithubᚗcomᚋforranaᚋgrammarᚑtrainerᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNTodo2githubᚗcomᚋforranaᚋgrammarᚑtrainerᚐTodo(ctx context.Context, sel ast.SelectionSet, v Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚕgithubᚗcomᚋforranaᚋgrammarᚑtrainerᚐTodo(ctx context.Context, sel ast.SelectionSet, v []Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTodo2githubᚗcomᚋforranaᚋgrammarᚑtrainerᚐTodo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTodo2ᚖgithubᚗcomᚋforranaᚋgrammarᚑtrainerᚐTodo(ctx context.Context, sel ast.SelectionSet, v *Todo) graphql.Marshaler {
	if v == nil {
